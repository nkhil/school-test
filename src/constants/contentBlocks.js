export default [
  {
    title: 'The Ultimate Aim of Education is to Create Empowered Knowledge',
    body:
  ...
  {
    title: 'Our Teachers Ensure All Round Student Development',
    body:
    ...
    buttonText: 'Read about our management committee',
    buttonPath: '/management-committee',
  },
  {
    title: 'Admissions Begin in December ',
    body:
